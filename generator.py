...
from data_process.ngramdatacolletor import get_unigram_freq_prob_tensor, get_unigram_freq_prob_year_tensor
...
MODEL_CLASSES = {
    ...
    "gpt2-vocab-repr-rnn-window-concat": (GPT2LMHeadVocabReprRNNWindowConcatModel, GPT2Tokenizer),
    "gpt2-vocab-repr-rnn-window-attention": (GPT2LMHeadVocabReprRNNWindowAttentionModel, GPT2Tokenizer),
...
def main():
    ...
    if args.model_type == "gpt2-ngram":
        ...
        model = GPT2LMHeadUNIGRAMVocabReprRNNWindowWeightModel.from_pretrained(args.model_name_or_path,
                                                                               ...
                                                                               year_vocab_repr=torch.load(
                                                                                   "year_vocab_repr.pt"),
                                                                               window_size=args.window_size)
    elif args.model_type == "gpt2-vocab-repr-rnn-window-concat":
        model = GPT2LMHeadVocabReprRNNWindowConcatModel.from_pretrained(args.model_name_or_path,
                                                                        unigram_year_tensor=
                                                                        get_unigram_freq_prob_year_tensor(
                                                                            start_year=2000,
                                                                            end_year=2019,
                                                                        ...
                                                                        year_vocab_repr=torch.load(
                                                                            "year_vocab_repr.pt"),
                                                                        window_size=args.window_size)
    elif args.model_type == "gpt2-vocab-repr-rnn-window-attention":
        model = GPT2LMHeadVocabReprRNNWindowAttentionModel.from_pretrained(args.model_name_or_path,
                                                                           unigram_year_tensor=
                                                                           get_unigram_freq_prob_year_tensor(
                                                                               start_year=2000,
                                                                               end_year=2019,
    ...
    model_kwargs = {"previous_year_index": torch.tensor([19] * args.num_return_sequences, dtype=torch.long),
                    "is_generate": True}
    output_sequences = model.generate(
        input_ids=input_ids,
        max_length=min(1024, args.length + len(encoded_prompt[0])),
